...
def optimiserBundle(model, labels, device, optimiser_name, learning_rate, weight_decay, scheduler_patience=4):
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimiser, mode="min", factor=0.33, patience=scheduler_patience, min_lr=1e-6)
